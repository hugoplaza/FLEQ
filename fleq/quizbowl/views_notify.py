...
from fleq.quizbowl.models import Category, User
...
def notify_user(user, case, instance):
	...
	if case == 'new_tournament':
		...
		message += "http://trivial.libresoft.es/recover-account/" + recover.code + "\n\n"
...
def contactEmail(info):
	...
	message += u"\tThanks to contact with FLEQ Project (Free LibreSoft Educational Quizbowl - http://trivial.libresoft.es)."
