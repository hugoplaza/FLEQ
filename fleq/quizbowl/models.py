...
#							Félix Redondo <fredondo@libresoft.es>			#
#                                                                           #
#############################################################################
...
# Question categories of quizbowl
...
class Tournament(models.Model):
	...
	#game_message = models.CharField(max_length=256, default="")
...
class Score(models.Model):
	...
	player = models.ForeignKey(User)
	player_profile = models.ForeignKey(UserProfile)
	tournament = models.ForeignKey("Tournament")  # referenced model name between quotations marks ("") to avoid previous declaration requirement 
...
class Mensajes(models.Model):
    ...
    acierto = models.IntegerField(default=0)
...
class Preguntas_acertadas(models.Model):
	question = models.ForeignKey(Question)
	num_aciertos = models.IntegerField(default=0)
	torneo = models.CharField(max_length=40)
